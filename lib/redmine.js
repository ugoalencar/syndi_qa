...
// Grava Responsavel/Quantidades/identidade na issue aberta do GTIN, num PUT so. Devolve
// { gravado: false } sem tocar na rede so se NENHUM campo, nem userId, vier preenchido -
// na pratica isso nao acontece mais em uso normal, ja que o front-end exige identidade
// configurada antes de chamar esta funcao (userId sempre presente). Lanca erro se nao
// achar issue aberta ou o PUT falhar - quem chama (POST /api/aprovar) BLOQUEIA o aprovar
// nesse caso, diferente do retrabalho.
