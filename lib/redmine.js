...
// Grava Situacao/Responsavel/Quantidades/identidade na issue aberta do GTIN, num PUT so -
// usada pela aba "QA para Edicao", independente do fluxo do Aprovar (que usa
// gravarCamposEdicao e nunca grava Situacao). Devolve { gravado: false } sem tocar na rede
// so se NENHUM campo, nem userId, vier preenchido - na pratica isso nao acontece mais em
// uso normal (front-end exige identidade configurada antes de chamar esta funcao). Lanca
// erro se nao achar issue aberta ou o PUT falhar.
